         ...
         <ul class="side-menu">
            ...
            <li class="slide">
               <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                  ...
                  <span class="side-menu__label">Admin Related</span><i class="angle fe fe-chevron-right"></i>
               </a>
               <ul class="slide-menu">
                  <li class="side-menu-label1">
                     <a href="javascript:void(0)">Forms</a>
                  </li>
                  <li><a href="{{ route('admin.details') }}" class="slide-item">Admins</a></li>
               </ul>
            </li>
            @endif
            <li class="slide">
               <a class="side-menu__item" data-bs-toggle="slide" href="javascript:void(0)">
                  ...
                  <span class="side-menu__label">News Related</span><i class="angle fe fe-chevron-right"></i>
               </a>
               <ul class="slide-menu">
                  <li class="side-menu-label1">
                     <a href="javascript:void(0)">Forms</a>
                  </li>
                  <li><a href="{{ route('post') }}" class="slide-item"> News Post</a></li>
