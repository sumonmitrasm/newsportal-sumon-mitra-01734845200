      ...
      <div class="container-fluid main-container">
         ...
         <div class="page-header">
            <div class="page-leftheader">
               <h4 class="page-title">News Dashboard</h4>
            </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-md-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <p class=" mb-1 ">All Staff</p>
                           <h2 class="mb-1 font-weight-bold">{{$admin}}</h2>
                           <span class="mb-1 text-muted"><span class="text-danger"><i class="fa fa-caret-down  me-1"></i> {{$admin}}</span> than last month</span>
                           <div class="progress progress-sm mt-3 bg-success-transparent">
                              <div class="progress-bar progress-bar-striped progress-bar-animated bg-success" style="width: {{$admin}}%"></div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-4 col-lg-4 col-md-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <p class=" mb-1 ">All Coustomer</p>
                           <h2 class="mb-1 font-weight-bold">{{$coustomer}}</h2>
                           <span class="mb-1 text-muted"><span class="text-success"><i class="fa fa-caret-up  me-1"></i> {{$coustomer}}</span> than last month</span>
                           <div class="progress progress-sm mt-3 bg-secondary-transparent">
                              <div class="progress-bar progress-bar-striped progress-bar-animated bg-secondary" style="width: {{$coustomer}}%"></div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-xl-4 col-lg-4 col-md-12">
                     <div class="card">
                        <div class="card-body">
                           ...
                           <p class=" mb-1 ">All News</p>
                           <h2 class="mb-1 font-weight-bold">{{$post}}</h2>
                           <span class="mb-1 text-muted"><span class="text-success"><i class="fa fa-caret-up  me-1"></i> {{$post}}%</span> than last month</span>
                           <div class="progress progress-sm mt-3 bg-primary-transparent">
                              <div class="progress-bar progress-bar-striped progress-bar-animated bg-primary" style="width: {{$post}}%"></div>
                           </div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="row">
                           <div class="col-xl-8 col-md-12 col-lg-7 pb-5">
                              <div class="card-header pb-50  border-0">
                                 <h4 class="card-title">News Base Website</h4>
                              </div>
                              <div  class="vmap-width"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Well Come </div>
                           </div>
            ...
            <div class="col-xl-3 col-md-12 col-lg-6">
               <div class="card">
                  <div class="d-block mt-4 card-header border-0 text-center">
                     <h2 class="text-center">Well Come <b>{{ Auth::guard('admin')->user()->name }}</b></h2>
                  </div>
               </div>
            </div>
